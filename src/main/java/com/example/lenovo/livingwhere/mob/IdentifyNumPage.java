 ...
 *
 * Copyright (c) 2014年 cn.edu.sdu.online.mob.com. All rights reserved.
 */
package com.example.lenovo.livingwhere.mob;
...
public class IdentifyNumPage extends FakeActivity implements OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (id == id_ll_back) {
            ...
            if (!TextUtils.isEmpty(code)) {
                ...
                pd = DialogUtil.createLoadingDialog(activity, "加载中...");
                if (pd != null) {
                    pd.show();
                }
                SMSSDK.submitVerificationCode(code, phone, verificationCode);//验证
            } else {
    ...
    //验证成功后的注册
    private void startRegister(final String phoneNum, final String password) {
//        // 打开对话框
       final Dialog dialog = DialogUtil.createLoadingDialog(getContext(),
                getContext().getString(R.string.waitingDialog));
        dialog.show();
        StringRequest registerRequest = new StringRequest(Request.Method.POST, URI.RegisterAddr,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.v("IdentifyNumPage", phoneNum);
        ...
        MyApplication.mQueue.add(registerRequest);
        ...
        runOnUIThread(new Runnable() {
            public void run() {
                ...
                if (result == SMSSDK.RESULT_COMPLETE) {//验证成功！！！
                    ...
                    res.put("phone", data);
                    setResult(res);
                    Log.v("IdentifyNumPage", "验证成功");

                    // TODO
                    startRegister(phone, RegisterPage.passw);
