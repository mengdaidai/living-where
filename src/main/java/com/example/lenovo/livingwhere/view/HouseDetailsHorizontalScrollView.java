...
/**
 * HouseDetailsFragment里面照片展示用的类
 */
public class HouseDetailsHorizontalScrollView extends HorizontalScrollView implements
        OnClickListener {
    ...
    //现在显示在ScrollView中的最后一个图片的index
    private int mCurrentIndex;
    //现在显示在ScrollView中的第一个图片的index
    ...
    public HouseDetailsHorizontalScrollView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // 获得屏幕宽度
